...
public class ContentJdbcTemplateRepository {
    ...
    //use method : query:
    //加入sql指令:"SELECT * FROM Content";
    //使用spring jdbc進行讀取查詢:
    //SQL - 選擇查詢語句來讀取content post記錄訊息;
    //ContentJdbcTemplateRepository物件從資料庫中讀取Content物件。
    //mapRow物件將content映射到Content物件。
